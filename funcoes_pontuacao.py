...
def uso_em_tags(soup, termo):
  ...
  pontuacao_uso_em_tags = pontuacao_title + pontuacao_meta + pontuacao_h1 + pontuacao_h2 + pontuacao_p + pontuacao_a

  print(f"Uso dos Termos: {pontuacao_title} (title) + {pontuacao_meta} (meta) + {pontuacao_h1} (h1) + {pontuacao_h2} (h2) + {pontuacao_p} (p) + {pontuacao_a} (a) = {pontuacao_uso_em_tags} pontos")
